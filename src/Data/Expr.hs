...
instance Substitutable1 ty expr => Substitutable1 ty (Ann expr ann) where
  liftSubstitute recur subst (Ann ann expr) = first (Ann ann) (liftSubstitute recur subst expr)
